...
const DICT = {
  ja: {
    ...
    enter: "入室する →",
    enterVR: "VRで入室 →",
    vrUnsupported: "お使いの環境は VR(WebXR) に対応していません",
    back: "← 入口",
    modeThird: "歩く(三人称)",
    modeWalk: "歩く(一人称)",
    modeOrbit: "見回す",
    ...
    urlLoad: "読み込む",
    tutWatch: "使い方（動画）",
    urlExample: "例: IIIF Cookbook コレクションを入れる",
    ...
    close: "閉じる (Esc)",
    vrHelp: "左スティック: 移動（前後左右）　右スティック: 30°ずつ回転　作品に近づくと高精細に",
  },
  en: {
    ...
    enter: "Enter →",
    enterVR: "Enter in VR →",
    vrUnsupported: "Your device does not support VR (WebXR)",
    back: "← Lobby",
    ...
    urlLoad: "Load",
    tutWatch: "Tutorial video",
    urlExample: "Try an example: IIIF Cookbook collection",
    ...
    close: "Close (Esc)",
    vrHelp: "Left stick: move (all directions)　Right stick: snap-turn 30°　Walk up to a work for higher detail",
  },
};
