...
const DICT = {
  ja: {
    ...
    zoomHintE: "E で拡大",
    helpHtml:
      "見回す: ドラッグ/ホイール ・ 歩く: WASD／矢印（スマホはスティック）<br>作品にカーソル → <b>🔍ボタン</b>（歩行中は<b>E</b>）で拡大 ・ Esc で戻る",
    walkBig: "クリックで歩行開始",
  ...
  en: {
    ...
    helpHtml:
      "Look: drag / wheel ・ Walk: WASD / arrows (stick on mobile)<br>Aim at a work → <b>🔍 button</b> (or <b>E</b> while walking) to zoom ・ Esc to exit",
